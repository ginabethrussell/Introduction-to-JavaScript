...
// console.log('Stretch - Rock, Paper, Scissors with User Input \n');

// function playRPS(){

//     alert('Let\'s play Rock, Paper, Scissors.');
    
//     // Get a valid entry from the user
//     const userEntry = getValidUserEntry();

//     // Check to see if user decided not to play
//     if (userEntry === -1) {
//         console.log('Maybe we can play later.\n');
//         return;
//     }

//     // convert userEntry string into an integer value (0,1,2) 
//     // for easier comparison with computer choice
//     const userChoice = convertUserEntry(userEntry);
...
// function getValidUserEntry(){
//     const validChoices = ['rock', 'paper', 'scissors'];
//     let isEntryValid = false;
//     while (!isEntryValid){
//         let text = prompt('Enter your choice (rock, paper, or scissors) to start: ');
//         console.log(text);
//         //check to see if user hit cancel or entered an empty string
//         if (text === null || text === ''){
//             return -1; //end the game
//         }else {
//             // strip off any whitespace from user entry and convert to lowercase
//             let userEntry = text.trim().toLowerCase();
//             //check to see if user entered a valid choice
//             if (validChoices.includes(userEntry)){
//                 return userEntry;
//             }else {
//                 // give user an error message and repeat the while loop
//                 alert('You can only enter rock, paper, or scissors. Click cancel  or enter to quit.');
//             }
//         }
//     }
// }
